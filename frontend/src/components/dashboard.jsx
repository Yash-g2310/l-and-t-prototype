                            ...
                            {stats.map((stat, index) => (
                                ...
                                >
                                    <div className="flex justify-between items-start mb-3">
                                        <div className="p-2 rounded-lg bg-neutral-100 dark:bg-neutral-700">{stat.icon}</div>
                                        <span
                                    ...
                                    <CardBody className="w-full bg-neutral-900 rounded-xl p-6 text-white">
                                        ...
                                        >
                                            ...
                                            <TextRevealCardDescription>
                                                Streamline your construction projects with advanced AI tools for planning, monitoring, and
                                                optimization. Hover over this card to see what our platform can do for you.
                                            </TextRevealCardDescription>
                                        </TextRevealCard>
                                    </CardBody>
                                </CardContainer>
                                    ...
                                    <CardBody className="relative w-full bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 shadow-sm p-6">
                                        <CardItem translateZ={20}>
                                            ...
                                            <div className="mt-4 space-y-4">
                                                {[
                                                    { name: 'Project Alpha', progress: 78, color: 'green' },
                                                    { name: 'Project Beta', progress: 45, color: 'amber' },
                                                    { name: 'Project Gamma', progress: 92, color: 'blue' },
                                                ].map((project, index) => (
                                                    <div key={index} className="space-y-2">
                                                        <div className="flex justify-between">
                                                            <span className="text-sm text-neutral-600 dark:text-neutral-400">{project.name}</span>
                                                            <span
                                                                className={`text-sm font-medium text-${project.color}-600 dark:text-${project.color}-400`}
                                                            >
                                                                {project.progress}%
                                                            </span>
                                                        </div>
                            ...
                            <div className="space-y-6">
                                <div className="bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 p-5">
                                    ...
                                    <div className="space-y-4">
                                        {[
                                            ...
                                            <div
                                                key={index}
                                                className="flex items-start space-x-3 pb-3 border-b border-neutral-100 dark:border-neutral-700 last:border-0 last:pb-0"
                                            >
                                ...
                                <div className="bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 p-5">
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        {[
                                            { title: 'New Project', color: 'blue' },
                                            { title: 'Schedule', color: 'purple' },
                                            { title: 'Reports', color: 'amber' },
                                            { title: 'Team', color: 'emerald' },
                                        ].map((action, index) => (
                                            <button
                                                key={index}
                                                className={`p-3 rounded-lg bg-${action.color}-50 dark:bg-${action.color}-900/20 text-${action.color}-700 dark:text-${action.color}-400 text-xs font-medium`}
                                            >
                                                {action.title}
                                            </button>
                                        ))}
                                ...
                                <div className="bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 p-5">
                                    ...
                                    <div className="space-y-3">
                                        {[
                                            ...
                                            <div
                                                key={index}
                                                className="flex justify-between items-center p-2 rounded-lg bg-neutral-50 dark:bg-neutral-700/50"
                                            >
                                                <div>
